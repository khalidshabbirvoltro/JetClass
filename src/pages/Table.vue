    ...
    <q-page-container>
      <q-page class="q-pa-xl">
        <TableComponent title="Table" :rows="dogs" :columns="columns" headerclasses="bg-dark text-white"
          :pagination="pagination" :onReuestFunction="onRequest" :loading="loading" :tablestripe="true" :flat="flat"
          :hidepaggination="false" :buttons="tableButtons"  :buttonNames="['edit', 'delete']" />
      </q-page>
    </q-page-container>
